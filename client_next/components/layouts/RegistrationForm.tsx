...
export default function RegistrationForm() {
    ...
    return (
        <div className="border border-black/10 rounded-lg px-10 py-5">
            ...
            <input type="text" placeholder="demousername09" className="outline-none h-10 bg-black/5 w-full rounded-md p-3 my-2 text-[0.95rem]"/>

            <p className="font-semibold">Email</p>
            <input type="email" placeholder="demo9@gmail.com" className="outline-none h-10 bg-black/5 w-full rounded-md p-3 my-2 text-[0.95rem]"/>

            <p className="font-semibold">Set a password</p>
            <div className="relative">
                <input type={showPassword ? "text" : "password"} placeholder="Enter a password" className="outline-none h-10 bg-black/5 w-full rounded-md p-3 my-2 text-[0.95rem] pr-10"/>
            ...
            <div className="relative">
                <input type={showConfirmPassword ? "text" : "password"} placeholder="Confirm your password"className="outline-none h-10 bg-black/5 w-full rounded-md p-3 my-2 text-[0.95rem] pr-10"/>
