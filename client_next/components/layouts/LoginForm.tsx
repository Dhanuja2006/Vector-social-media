...
export default function LoginForm() {
    ...
    return (
        <div className="border border-black/10 rounded-lg px-10 py-5">
            ...
            <input type="text" placeholder="demousername09" className="outline-none h-10 bg-black/5 w-full rounded-md p-3 my-2"/>
            <p className="font-semibold">Password</p>

            <div className="relative">
                <input type={showPassword ? "text" : "password"} placeholder="Enter your password"
                    className="outline-none h-10 bg-black/5 w-full rounded-md p-3 my-2 pr-10"/>
