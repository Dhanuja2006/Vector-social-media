...
export default function navbar() {
    return (
        <div className="hidden md:flex h-15 z-20 py-5 px-10 absolute bg-white/95 dark:bg-black/95 left-1/2 -translate-x-1/2 items-center justify-between w-170 mx-auto border border-black/10 dark:border-white/20 rounded-full my-5">
